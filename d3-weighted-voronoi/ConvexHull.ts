import { dot, epsilonesque, linearDependent } from "./calculateWeight";
import { Vertex } from "./Vertex";
import { Face } from "./Face";
import { ConflictListNode } from "./ConflictList";
...
class ConvexHull {
  ...
  // IN: sites (x,y,z)
  public init(boundingSites: any, sites: any) {
    this.points = [];
  ...
  public addConflicts = (function(old1: any, old2: any, fn: any) {
    ...
    for (var i: any = nCL.length - 1; i >= 0; i--) {
      v1 = nCL[i];
