...
import { randomInitialPosition } from "./initPosition"
import { halfAverageAreaInitialWeight } from "./initPosition";
import { FlickeringMitigation } from "./FlickeringMitigation"
import { d3VoronoiMapError } from "../utils/d3-voronoi-map";
...
function voronoiMapSimulation(data) {
    ...
    const HANDLE_OVERWEIGHTED_VARIANT:Number = 1; // this option still exists 'cause for further experiments
